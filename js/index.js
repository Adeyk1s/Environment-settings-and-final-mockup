...
function toggleMoreItems() {
  ...
  showMoreBtn.innerHTML = isMoreVisible
    ? "<img src='./icon/expand-false.svg' alt=''> Скрыть"
    : "<img src='./icon/expand-true.svg' alt=''> Показать все";
}
...
btnAside.addEventListener('click', function(){
  ...
  popupWrapper.style = "display: block; position:fixed; left:0; width: 100%; background: rgba(255, 255, 255, 0.9); z-index:6; height: 100%;";
...
btnAsideClose.addEventListener("click", function(){
  ...
  btnAsideClose.style.display = "none";
  popupWrapper.style = "";
})